...
void cameraManager::update_cam_front(GLFWwindow *const window, double xpos,
                                     double ypos) {
    ...
    if (pitch > pitch_max_limit) pitch = pitch_max_limit;
    if (pitch < pitch_min_limit) pitch = pitch_min_limit;
